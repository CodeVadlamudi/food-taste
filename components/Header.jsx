    ...
    <header>
      ...
      <div className="bg-white px-5 py-4">
        <div className="max-w-screen-xl mx-auto flex items-center justify-between">
          ...
          <nav
            className={`absolute top-[118px] p-8 flex flex-col bg-white left-0 w-full space-y-4 duration-300 md:relative md:top-0 md:p-0 md:flex-row md:w-auto md:space-y-0 md:space-x-6 z-10 border-t md:border-t-0 ${
