  ...
  return (
    <footer className="bg-zinc-800">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-4 text-zinc-200 gap-10 py-10 sm:py-14 md:py-16 lg:py-20 px-10">
          {/* Footer Col - 1 */}
          ...
          <div className="space-y-4 col-span-2 lg:col-span-1">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <a
                href="/about"
                className="hover:text-red-500 text-base sm:text-lg">
                About
              </a>
              <a
                href="/about"
        ...
        <div className="py-5 border-t text-white flex items-center justify-between px-10">
          ...
          <a
            ...
            <img
              ...
              className="w-5 h-5"
            />
            <h4 className="hidden md:block">Code Vadlamudi</h4>
          </a>
        </div>
      </div>
    </footer>
